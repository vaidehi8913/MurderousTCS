...
export const CONTENT_WIDTH = 2000; // fixed width of the content box
    ...
    export const CHAPTER_TITLE_FONT_SIZE = 100; // for chapter heading
        ...
        export const CHIBI_SIZE = 400; // width of chibi sprites
        export const CHIBI_MARGIN = 20; // margin between chibi image and dialogue text
        export const SPEAKER_MARGIN = 20; // bottom margin between one speaker and the next 
